...
extern void c_pctex_hline(int x1, int x2, float z1, float z2, int y, float btx1, float btx2, float bty1, float bty2, int tw, uchar *tex);
...
static void setup_prims(void)
{
	...
	pctex_hline_prim  = c_pctex_hline;
